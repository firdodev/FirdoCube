...
namespace magic_cube {
    public class FirdoCube : Cube { 
        ...
        private Dictionary<CubeFace, Material> faceColors = new Dictionary<CubeFace, Material> {
            ...
            {CubeFace.F, new DiffuseMaterial(new SolidColorBrush(Colors.Purple))}
        };
        
        public FirdoCube(int size, Point3D o, TimeSpan duration, double len = 1, double space = 0.1) {
            this.size = size;
            this.origin = o;
            this.edge_len = len;
            this.space = space;
        ...
        public FirdoCube(CubeFace[,] projection, int size, Point3D o, TimeSpan duration, double len = 1, double space = 0.1) {
            this.size = size;
            this.origin = o;
            this.edge_len = len;
            this.space = space;
